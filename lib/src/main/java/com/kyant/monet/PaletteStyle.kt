...
public class PaletteStyle(
    public val accent1Spec: ColorSpec,
    public val accent2Spec: ColorSpec,
    public val accent3Spec: ColorSpec,
    public val neutral1Spec: ColorSpec,
    ...
    public companion object {
        ...
        public val TonalSpot: PaletteStyle = PaletteStyle(
        ...
        public val Spritz: PaletteStyle = PaletteStyle(
        ...
        public val Vibrant: PaletteStyle = PaletteStyle(
        ...
        public val Expressive: PaletteStyle = PaletteStyle(
        ...
        public val Rainbow: PaletteStyle = PaletteStyle(
            accent1Spec = ColorSpec({ 48.0 }) { 0.0 },
            accent2Spec = ColorSpec({ 16.0 }) { 0.0 },
            accent3Spec = ColorSpec({ 24.0 }) { -60.0 },
        ...
        public val FruitSalad: PaletteStyle = PaletteStyle(
        ...
        public val Content: PaletteStyle = PaletteStyle(
